...
export default [].concat(configUsage, tokenUsage, initUsage, addUsage, updateUsage, deleteUsage, getUsage);

export { configUsage, tokenUsage, initUsage, addUsage, updateUsage, deleteUsage, getUsage };
