...
export default [
    {
        ...
        content: 'Initialize project structure' + EOL + EOL +
            'fliff init'.code + EOL + EOL +
            `This command should be run first time under Firebase project root folder which containing ${'firebase.json'.code}` + EOL + EOL +
