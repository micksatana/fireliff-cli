...
describe('ThingsDeleteTrialProductRequest', () => {
    ...
    describe('when create an instance with options.accessToken', () => {
        ...
        beforeAll(() => {
            ...
            req = new ThingsDeleteTrialProductRequest({ accessToken });
        });

        it('should have correct endpoint', () => {
            expect(req.endpoint).toEqual('https://api.line.me/things/v1/trial/products');
        });
        ...
        describe('when send productId', () => {
            ...
            it('should call to correct endpoint', () => {
                ...
                expect(req.axios.delete).toHaveBeenCalledWith(`${req.endpoint}/${productId}`);
            });
            afterAll(() => {
