    ...
    describe('createTrialProduct', () => {
        ...
        describe('when failed with detail', () => {
            ...
            it('reject with error', () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToCreateTrial + EOL + error.response.data.detail.warn));
            });
        ...
        describe('when failed with 400', () => {
            ...
            it('reject with error', () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToCreateTrial400));
            });
        ...
        describe('when failed with 401', () => {
            ...
            it('reject with error', () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToCreateTrial401));
            });
        ...
        describe('when failed with 403', () => {
            ...
            it('reject with error', async () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToCreateTrial403));
            });
        ...
        describe('when failed with unknown', () => {
            ...
            it('reject with error', async () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToCreateTrial));
            });
