    ...
    describe('getProduct', () => {
        ...
        describe('when success', () => {
            ...
            beforeAll(async () => {
                ...
                ThingsGetProductRequest.mockImplementation(() => { return req; });
                things = new Things();
        ...
        describe('when failed with 401', () => {
            ...
            beforeAll(async () => {
                ...
                ThingsGetProductRequest.mockImplementation(() => { return req; });
                things = new Things();
                await things.getProduct(deviceId).catch(catchedError => result = catchedError);
            });

            it('reject with error', () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToGetProduct401));
            });
        ...
        describe('when failed with 404', () => {
            ...
            it('reject with error', async () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToGetProduct404));
            });
        ...
        describe('when failed with unknown', () => {
            ...
            it('reject with error', async () => {
                expect(result).toEqual(new ThingsError(Things.ErrorMessages.FailedToGetProduct));
            });
