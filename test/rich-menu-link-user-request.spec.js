...
import { RichMenuLinkUserRequest } from '../lib/rich-menu-link-user-request';
    ...
    describe('when create an instance with options.accessToken', () => {
        ...
        describe('when send richMenuId', () => {
            ...
            it('should call to correct endpoint', () => {
                ...
                expect(req.axios.post).toHaveBeenCalledWith(`${req.endpoint}/user/${userId}/richmenu/${richMenuId}`);
            });
            afterAll(() => {
