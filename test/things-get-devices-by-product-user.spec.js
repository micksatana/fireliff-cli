  ...
  describe('getDevicesByProductUser', () => {
    ...
    describe('when success', () => {
      ...
      beforeAll(async () => {
        ...
        ThingsGetDevicesByProductUserRequest.mockImplementation(() => {
          return req;
        });
        things = new Things();
      ...
      it('create request with access token', () => {
        expect(ThingsGetDevicesByProductUserRequest).toHaveBeenCalledWith({
          accessToken,
        });
      });
    ...
    describe('when failed with 401', () => {
      ...
      beforeAll(async () => {
        ...
        things = new Things();
        await things
          .getDevicesByProductUser(productId, userId)
    ...
    describe('when failed with unknown', () => {
      ...
      it('reject with error', async () => {
        expect(result).toEqual(
          new ThingsError(Things.ErrorMessages.FailedToGetDevicesByProductUser)
        );
      });
    });
  });
