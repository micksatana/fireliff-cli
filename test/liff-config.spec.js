...
describe('LIFFConfig', () => {
  describe('setView', () => {
    beforeAll(() => {
      jest
        .spyOn(FunctionsConfig, 'set')
        .mockImplementation((_, value) => Promise.resolve(value));
    ...
    it('should set to correct config group', () => {
      expect(FunctionsConfig.set).toHaveBeenCalledWith(
        `${LIFFConfig.ViewsGroup}.testname`,
        'testvalue'
      );
    });
  ...
  describe('unsetView', () => {
    ...
    it('should unset to correct config group', () => {
      expect(FunctionsConfig.unset).toHaveBeenCalledWith(
        `${LIFFConfig.ViewsGroup}.testname`
      );
    });
  ...
  describe('getViewNamesById', () => {
    beforeAll(() => {
      jest
        .spyOn(FunctionsConfig, 'getNamesById')
        .mockImplementation(() => Promise.resolve([]));
      LIFFConfig.getViewNamesById('testid', {});
    });

    it('should unset to correct config group', () => {
      expect(FunctionsConfig.getNamesById).toHaveBeenCalledWith(
        LIFFConfig.ViewsGroup,
        'testid',
        {}
      );
    });
  ...
  describe('getViewNameById', () => {
    describe('when found names', () => {
      ...
      beforeAll(async () => {
        jest
          .spyOn(LIFFConfig, 'getViewNamesById')
          .mockImplementation(() => Promise.resolve(['name-1', 'name-2']));
  ...
  describe('getViewIdByName', () => {
    beforeAll(() => {
      jest
        .spyOn(FunctionsConfig, 'getIdByName')
        .mockImplementation(() => Promise.resolve([]));
      LIFFConfig.getViewIdByName('testname', {});
    });

    it('should unset to correct config group', () => {
      expect(FunctionsConfig.getIdByName).toHaveBeenCalledWith(
        LIFFConfig.ViewsGroup,
        'testname',
        {}
      );
  ...
  describe('setRichMenu', () => {
    ...
    it('should set to correct config group', () => {
      expect(FunctionsConfig.set).toHaveBeenCalledWith(
        `${LIFFConfig.RichMenusGroup}.testname`,
        'testvalue'
      );
    });
  ...
  describe('getRichMenuNameById', () => {
    describe('when found names', () => {
      ...
      beforeAll(async () => {
        jest
          .spyOn(LIFFConfig, 'getRichMenuNamesById')
          .mockImplementation(() => Promise.resolve(['name-1', 'name-2']));
        result = await LIFFConfig.getRichMenuNameById('testid', {});
      });

      it('should get names', () => {
        expect(LIFFConfig.getRichMenuNamesById).toHaveBeenCalledWith(
          'testid',
          {}
        );
      });
