...
import { RichMenuSetDefaultRequest } from '../lib/rich-menu-set-default-request';
...
describe('RichMenuSetDefaultRequest', () => {
    ...
    describe('when create an instance with options.accessToken', () => {
        ...
        it('should have correct endpoint', () => {
            expect(req.endpoint).toEqual('https://api.line.me/v2/bot/user/all/richmenu');
        });
        ...
        describe('when send richMenuId', () => {
            ...
            it('should call to correct endpoint', () => {
                ...
                expect(req.axios.post).toHaveBeenCalledWith(`${req.endpoint}/${richMenuId}`);
            });
            afterAll(() => {
